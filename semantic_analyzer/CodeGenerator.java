        ...
        switch (func) {
            ...
            case "assign":
                ...
                if (type2.equals("i8*")) {
                    ...
                    code.add("%var" + variable_count + " = bitcast array_size " + tmp.getVal() + " to i8*");
                    variable_count++;
                    code.add("call void @llvm.memcpy.p0i8.p0i8.i64(i8* " + "%var" + variable_count + ", i8* " + expr1.getVal() + "), i64 30, i32 16, i1 false)");
                }
